...
#PBS -N SBEL-Porter-all-male-surv
#PBS -l ncpus=3
#PBS -l mem=20GB
#PBS -l walltime=36:00:00
#PBS -l cpuarch=avx2
#PBS -o SBEL-Porter-all-male-surv_stdout.out
#PBS -e SBEL-Porter-all-male-surv_stderr.out
...
run_program(){
  ...
  cd $PBS_O_WORKDIR
  Rscript "Rscripts/SBEL Porter fitting all cancer.R" 
